...
@Component({
  ...
  templateUrl: './employee-leave-request-editor.tablet.html',
  styleUrls: ['./employee-leave-request-editor.tablet.scss'],
  providers: [
...
export class EmployeeLeaveRequestEditorTablet extends EmployeeLeaveRequestEditorComponent {
  constructor(
