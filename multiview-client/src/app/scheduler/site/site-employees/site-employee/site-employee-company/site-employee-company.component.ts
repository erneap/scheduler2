...
@Component({
  selector: 'app-site-employee-company',
  templateUrl: './site-employee-company.component.html',
  styleUrls: ['./site-employee-company.component.scss']
})
export class SiteEmployeeCompanyComponent {
