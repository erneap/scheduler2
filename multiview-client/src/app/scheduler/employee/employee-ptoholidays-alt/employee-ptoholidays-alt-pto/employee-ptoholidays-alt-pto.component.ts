...
@Component({
  selector: 'app-employee-ptoholidays-alt-pto',
  templateUrl: './employee-ptoholidays-alt-pto.component.html',
  styleUrls: ['./employee-ptoholidays-alt-pto.component.scss']
})
export class EmployeePtoholidaysAltPtoComponent {
  ...
  widthStyle(): string {
    const answer = `width: ${this.width}px;`;
    return answer;
  }
