...
@Component({
  selector: 'app-reports-site-enterprise',
  templateUrl: './reports-site-enterprise.component.html',
  styleUrls: ['./reports-site-enterprise.component.scss']
})
export class ReportsSiteEnterpriseComponent {
