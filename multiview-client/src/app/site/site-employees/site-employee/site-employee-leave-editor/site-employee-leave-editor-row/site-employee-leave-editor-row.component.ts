...
@Component({
  selector: 'app-site-employee-leave-editor-row',
  templateUrl: './site-employee-leave-editor-row.component.html',
  styleUrls: ['./site-employee-leave-editor-row.component.scss']
})
export class SiteEmployeeLeaveEditorRowComponent {
