...
@Component({
  selector: 'app-reports-site-mid-shift',
  templateUrl: './reports-site-mid-shift.component.html',
  styleUrls: ['./reports-site-mid-shift.component.scss']
})
export class ReportsSiteMidShiftComponent {
