...
@Component({
  selector: 'app-employee-ptoholidays-holiday-cell-display',
  templateUrl: './employee-ptoholidays-holiday-cell-display.component.html',
  styleUrls: ['./employee-ptoholidays-holiday-cell-display.component.scss']
})
export class EmployeePTOHolidaysHolidayCellDisplayComponent {
