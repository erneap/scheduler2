...
@Component({
  selector: 'app-employee-ptoholidays-ptomonth-display',
  templateUrl: './employee-ptoholidays-ptomonth-display.component.html',
  styleUrls: ['./employee-ptoholidays-ptomonth-display.component.scss']
})
export class EmployeePTOHolidaysPTOMonthDisplayComponent {
