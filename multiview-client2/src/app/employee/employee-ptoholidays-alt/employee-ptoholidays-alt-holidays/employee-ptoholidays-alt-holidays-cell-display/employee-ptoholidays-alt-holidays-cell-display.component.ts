...
@Component({
  selector: 'app-employee-ptoholidays-alt-holidays-cell-display',
  templateUrl: './employee-ptoholidays-alt-holidays-cell-display.component.html',
  styleUrls: ['./employee-ptoholidays-alt-holidays-cell-display.component.scss']
})
export class EmployeePtoholidaysAltHolidaysCellDisplayComponent {
