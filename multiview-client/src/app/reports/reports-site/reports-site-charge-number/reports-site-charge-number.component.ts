...
@Component({
  selector: 'app-reports-site-charge-number',
  templateUrl: './reports-site-charge-number.component.html',
  styleUrls: ['./reports-site-charge-number.component.scss']
})
export class ReportsSiteChargeNumberComponent {
