...
@Component({
  selector: 'app-site-employee-leave-editor',
  templateUrl: './site-employee-leave-editor.component.html',
  styleUrls: ['./site-employee-leave-editor.component.scss'],
  providers: [
...
export class SiteEmployeeLeaveEditorComponent {
