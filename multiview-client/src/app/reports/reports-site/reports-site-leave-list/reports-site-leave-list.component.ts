...
@Component({
  selector: 'app-reports-site-leave-list',
  templateUrl: './reports-site-leave-list.component.html',
  styleUrls: ['./reports-site-leave-list.component.scss']
})
export class ReportsSiteLeaveListComponent {
