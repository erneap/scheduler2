...
@Component({
  selector: 'app-site-mid-schedule-year',
  templateUrl: './site-mid-schedule-year.component.html',
  styleUrls: ['./site-mid-schedule-year.component.scss']
})
export class SiteMidScheduleYearComponent {
