...
@Component({
  selector: 'app-site-file-ingest-month',
  templateUrl: './site-file-ingest-month.component.html',
  styleUrls: ['./site-file-ingest-month.component.scss']
})
export class SiteFileIngestMonthComponent {
