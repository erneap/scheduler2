...
@Component({
  selector: 'app-site-file-ingest-month-employee',
  templateUrl: './site-file-ingest-month-employee.component.html',
  styleUrls: ['./site-file-ingest-month-employee.component.scss']
})
export class SiteFileIngestMonthEmployeeComponent {
