...
@Component({
  selector: 'app-employee-ptoholidays-holiday-cell',
  templateUrl: './employee-ptoholidays-holiday-cell.component.html',
  styleUrls: ['./employee-ptoholidays-holiday-cell.component.scss']
})
export class EmployeePTOHolidaysHolidayCellComponent {
