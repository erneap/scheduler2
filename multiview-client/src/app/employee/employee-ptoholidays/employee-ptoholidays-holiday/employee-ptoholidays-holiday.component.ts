...
@Component({
  selector: 'app-employee-ptoholidays-holiday',
  templateUrl: './employee-ptoholidays-holiday.component.html',
  styleUrls: ['./employee-ptoholidays-holiday.component.scss']
})
export class EmployeePTOHolidaysHolidayComponent {
