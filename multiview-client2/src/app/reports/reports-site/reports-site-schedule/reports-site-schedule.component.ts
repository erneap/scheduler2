...
@Component({
  selector: 'app-reports-site-schedule',
  templateUrl: './reports-site-schedule.component.html',
  styleUrls: ['./reports-site-schedule.component.scss']
})
export class ReportsSiteScheduleComponent {
