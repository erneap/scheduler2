...
@Component({
  selector: 'app-employee-ptoholidays-pto',
  templateUrl: './employee-ptoholidays-pto.component.html',
  styleUrls: ['./employee-ptoholidays-pto.component.scss']
})
export class EmployeePTOHolidaysPTOComponent {
